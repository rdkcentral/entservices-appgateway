...
############################
# Build entservices-appgateway
echo "building entservices-appgateway"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-appgateway \
-DUSE_THUNDER_R4=ON \
