...
namespace Plugin {
    ...
    private:
        ...
        // Initialization state (atomic to allow lock-free reads in RecordTelemetryEvent/RecordTelemetryMetric
        // while Initialize()/Deinitialize() write it under mAdminLock)
