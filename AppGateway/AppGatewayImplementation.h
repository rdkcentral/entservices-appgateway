...
namespace Plugin {
    ...
    private:
        ...
        uint32_t PreProcessEvent(const Context &context, const std::vector<std::string>& aliases, const string &method, const string& origin, const string& params, string &resolution);
