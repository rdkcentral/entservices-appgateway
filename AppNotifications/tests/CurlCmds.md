...
## Action
```bash
curl -H 'Content-Type: application/json' -d '{"jsonrpc":"2.0","id":"100","method":"org.rdk.AppNotifications.1.subscribe","params": {"context": { "requestId":0, "appId":"com.example.app", "connectionId":"someConnectionguid" },"listen": true,"module": "org.rdk.AppGatewayCommon.1", "event": "TextToSpeech.Enabled"}}}' http://127.0.0.1:9998/jsonrpc
```